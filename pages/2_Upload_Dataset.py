...
from utils.ui import inject_global_css, hero, section_title, empty_state, footer, divider, premium_table, column_info_cards
...
if uploaded_file:
    ...
    if result:
        ...
        column_info_cards(result['df'], dtypes=result['dtypes'], missing_summary=result['missing_summary'])
