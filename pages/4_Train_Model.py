...
def render_results(result):
    ...
    if problem_type == 'regression':
        ...
        fig = px.scatter(
            ...
            color_discrete_sequence=["#2563EB"],
            # WEBGL FIX: see the matching comment in utils/eda_analyzer.py —
            # forces the plain SVG renderer instead of letting Plotly
            # auto-upgrade to a WebGL Scattergl trace on larger test sets.
            render_mode="svg",
        )
